...
package info.dyndns.gonnsen.mustangradio.Library;
...
/**
 * A {@link info.dyndns.gonnsen.example.Library.CommonUsbSerialPort} implementation for a variety of FTDI devices
 * <p>
 ...
 * {@link info.dyndns.gonnsen.example.Library.CommonUsbSerialPort#read(byte[], int)} and
 * {@link info.dyndns.gonnsen.example.Library.CommonUsbSerialPort#write(byte[], int)}.</li>
 * <li>Setting serial line parameters (see
 * {@link info.dyndns.gonnsen.example.Library.CommonUsbSerialPort#setParameters(int, int, int, int)}.</li>
 * </ul>
 * </p>
 * <p>
